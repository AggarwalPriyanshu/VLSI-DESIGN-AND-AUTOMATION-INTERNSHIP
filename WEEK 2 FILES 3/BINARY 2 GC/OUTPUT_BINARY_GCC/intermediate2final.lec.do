...
set_log_file logs_Jun20-10:27:26/intermediate2final.lec.log -replace

usage -auto -elapse

set_verification_information binary_to_gray_intermediatev_binary_to_grayv_db

read_implementation_information fv/binary_to_gray -golden binary_to_gray_intermediatev -revised binary_to_grayv
...
read_design -verilog95   -golden -lastmod -noelab outputs_Jun20-10:27:26/binary_to_gray_intermediate.v
elaborate_design -golden -root {binary_to_gray}

read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:27:26/binary_to_gray.v
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:27:26/intermediate2final.lec.log
}
