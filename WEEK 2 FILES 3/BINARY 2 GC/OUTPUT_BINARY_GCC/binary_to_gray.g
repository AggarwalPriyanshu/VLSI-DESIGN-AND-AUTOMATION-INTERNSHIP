...
# This file contains the Genus script for /designs/binary_to_gray
...
::legacy::set_attribute -quiet runtime_by_stage { {to_generic 0 38 0 4}  {first_condense 0 38 0 4}  {second_condense 0 38 0 4}  {reify 0 38 0 4}  {global_incr_map 0 38 0 4}  {incr_opt 0 39 0 5} } /
...
::legacy::set_attribute -quiet flow_metrics_snapshot_uuid acf19e10-1657-4599-a25a-66f1f800d644 /
...
# BEGIN MSV SECTION
# END MSV SECTION
define_cost_group -design /designs/binary_to_gray -name I2O
path_group -paths [specify_paths -from {{/designs/binary_to_gray/ports_in/bin[3]} {/designs/binary_to_gray/ports_in/bin[2]} {/designs/binary_to_gray/ports_in/bin[1]} {/designs/binary_to_gray/ports_in/bin[0]}} -to {{/designs/binary_to_gray/ports_out/gray[3]} {/designs/binary_to_gray/ports_out/gray[2]} {/designs/binary_to_gray/ports_out/gray[1]} {/designs/binary_to_gray/ports_out/gray[0]}}]  -name I2O -group /designs/binary_to_gray/timing/cost_groups/I2O
# BEGIN DFT SECTION
::legacy::set_attribute -quiet dft_scan_style muxed_scan /
::legacy::set_attribute -quiet dft_scanbit_waveform_analysis false /
# END DFT SECTION
::legacy::set_attribute -quiet seq_reason_deleted_internal {} /designs/binary_to_gray
::legacy::set_attribute -quiet qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 3} {utilization  0.00} {runtime 0 38 0 4} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 9} {utilization  0.00} {runtime 0 38 0 4} }{second_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 9} {utilization  0.00} {runtime 0 38 0 4} }{reify {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 6} {utilization  0.00} {runtime 0 38 0 4} }{global_incr_map {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 6} {utilization  0.00} {runtime 0 38 0 4} }{incr_opt {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 3} {utilization  0.00} {runtime 0 39 0 5} }} /designs/binary_to_gray
::legacy::set_attribute -quiet seq_mbci_coverage 0.0 /designs/binary_to_gray
::legacy::set_attribute -quiet hdl_filelist {{default -v2001 {SYNTHESIS} {/home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/BINARY_GCC.v} {/home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog} {}}} /designs/binary_to_gray
::legacy::set_attribute -quiet hdl_user_name binary_to_gray /designs/binary_to_gray
::legacy::set_attribute -quiet verification_directory fv/binary_to_gray /designs/binary_to_gray
::legacy::set_attribute -quiet arch_filename /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/BINARY_GCC.v /designs/binary_to_gray
::legacy::set_attribute -quiet entity_filename /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/BINARY_GCC.v /designs/binary_to_gray
::legacy::set_attribute -quiet original_name {bin[3]} {/designs/binary_to_gray/ports_in/bin[3]}
::legacy::set_attribute -quiet original_name {bin[2]} {/designs/binary_to_gray/ports_in/bin[2]}
::legacy::set_attribute -quiet original_name {bin[1]} {/designs/binary_to_gray/ports_in/bin[1]}
::legacy::set_attribute -quiet original_name {bin[0]} {/designs/binary_to_gray/ports_in/bin[0]}
::legacy::set_attribute -quiet original_name {gray[3]} {/designs/binary_to_gray/ports_out/gray[3]}
::legacy::set_attribute -quiet original_name {gray[2]} {/designs/binary_to_gray/ports_out/gray[2]}
::legacy::set_attribute -quiet original_name {gray[1]} {/designs/binary_to_gray/ports_out/gray[1]}
::legacy::set_attribute -quiet original_name {gray[0]} {/designs/binary_to_gray/ports_out/gray[0]}
...
## Written on 10:27:28 20-Jun 2025
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_flowkit_db flow_metrics_snapshot_uuid acf19e10-1657-4599-a25a-66f1f800d644}
