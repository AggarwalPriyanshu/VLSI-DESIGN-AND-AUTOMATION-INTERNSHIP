...
# Generated on: Fri Jun 20 10:27:28 IST 2025 (Fri Jun 20 04:57:28 UTC 2025)
...
set_log_file logs_Jun20-10:27:26/rtl2intermediate.lec.log -replace

usage -auto -elapse

set_verification_information rtl_binary_to_gray_intermediatev_db

read_implementation_information fv/binary_to_gray -revised binary_to_gray_intermediatev
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/BINARY_GCC.v
elaborate_design -golden -root {binary_to_gray} -rootonly 

read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:27:26/binary_to_gray_intermediate.v
elaborate_design -revised -root {binary_to_gray}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:27:26/rtl2intermediate.lec.log
}
