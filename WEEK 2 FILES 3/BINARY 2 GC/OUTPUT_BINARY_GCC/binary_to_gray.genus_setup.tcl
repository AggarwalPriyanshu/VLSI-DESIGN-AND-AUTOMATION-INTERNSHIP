...
################################################################################
if {[::legacy::find -design /designs/binary_to_gray] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj /designs/binary_to_gray
}
...
# Design
################################################################################
read_netlist -top binary_to_gray outputs_Jun20-10:27:26/binary_to_gray.v
read_metric -id current outputs_Jun20-10:27:26/binary_to_gray.metrics.json

phys::read_script outputs_Jun20-10:27:26/binary_to_gray.g
...
# slack
set _slk_ [::legacy::get_attribute slack /designs/binary_to_gray]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
...
# multi-mode slack
# tns
set _tns_ [::legacy::get_attribute tns /designs/binary_to_gray]
if {[regexp {^-?[0-9.]+$} $_tns_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area /designs/binary_to_gray]
...
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area /designs/binary_to_gray]
