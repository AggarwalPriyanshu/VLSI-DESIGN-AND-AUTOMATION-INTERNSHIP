...
# Generated on: Fri Jun 20 10:36:49 IST 2025 (Fri Jun 20 05:06:49 UTC 2025)
...
set_log_file logs_Jun20-10:36:47/rtl2intermediate.lec.log -replace

usage -auto -elapse

set_verification_information rtl_full_adder_intermediatev_db

read_implementation_information fv/full_adder -revised full_adder_intermediatev
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/FULL_ADDER.v
elaborate_design -golden -root {full_adder} -rootonly 

read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:36:47/full_adder_intermediate.v
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:36:47/rtl2intermediate.lec.log
}
