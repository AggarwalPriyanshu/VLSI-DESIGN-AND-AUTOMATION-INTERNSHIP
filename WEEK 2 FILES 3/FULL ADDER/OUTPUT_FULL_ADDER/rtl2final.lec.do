...
set_log_file logs_Jun20-10:36:47/rtl2final.lec.log -replace

usage -auto -elapse

set_verification_information rtl_full_adder_mv_db

read_implementation_information fv/full_adder -revised full_adder_mv
...
read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:36:47/full_adder_m.v
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:36:47/rtl2final.lec.log
}
