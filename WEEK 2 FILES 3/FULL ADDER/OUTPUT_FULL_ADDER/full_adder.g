...
# This file contains the Genus script for /designs/full_adder
...
::legacy::set_attribute -quiet runtime_by_stage { {to_generic 0 16 0 4}  {first_condense 0 16 0 4}  {second_condense 0 16 0 4}  {reify 0 16 0 4}  {global_incr_map 0 16 0 4}  {incr_opt 0 17 0 4} } /
...
::legacy::set_attribute -quiet flow_metrics_snapshot_uuid ac26bfe3-e322-4579-9a2a-f6ecf200ef6f /
...
# BEGIN MSV SECTION
# END MSV SECTION
define_cost_group -design /designs/full_adder -name I2O
path_group -paths [specify_paths -from {/designs/full_adder/ports_in/a /designs/full_adder/ports_in/b /designs/full_adder/ports_in/cin} -to {/designs/full_adder/ports_out/sum /designs/full_adder/ports_out/cout}]  -name I2O -group /designs/full_adder/timing/cost_groups/I2O
# BEGIN DFT SECTION
::legacy::set_attribute -quiet dft_scan_style muxed_scan /
::legacy::set_attribute -quiet dft_scanbit_waveform_analysis false /
# END DFT SECTION
::legacy::set_attribute -quiet seq_reason_deleted_internal {} /designs/full_adder
::legacy::set_attribute -quiet qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 16} {utilization  0.00} {runtime 0 16 0 4} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 10} {utilization  0.00} {runtime 0 16 0 4} }{second_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 10} {utilization  0.00} {runtime 0 16 0 4} }{reify {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 6} {utilization  0.00} {runtime 0 16 0 4} }{global_incr_map {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 6} {utilization  0.00} {runtime 0 16 0 4} }{incr_opt {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 1} {utilization  0.00} {runtime 0 17 0 4} }} /designs/full_adder
::legacy::set_attribute -quiet seq_mbci_coverage 0.0 /designs/full_adder
::legacy::set_attribute -quiet hdl_filelist {{default -v2001 {SYNTHESIS} {/home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/FULL_ADDER.v} {/home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog} {}}} /designs/full_adder
::legacy::set_attribute -quiet hdl_user_name full_adder /designs/full_adder
::legacy::set_attribute -quiet verification_directory fv/full_adder /designs/full_adder
::legacy::set_attribute -quiet arch_filename /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/FULL_ADDER.v /designs/full_adder
::legacy::set_attribute -quiet entity_filename /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/FULL_ADDER.v /designs/full_adder
::legacy::set_attribute -quiet original_name a /designs/full_adder/ports_in/a
::legacy::set_attribute -quiet original_name b /designs/full_adder/ports_in/b
::legacy::set_attribute -quiet original_name cin /designs/full_adder/ports_in/cin
::legacy::set_attribute -quiet original_name sum /designs/full_adder/ports_out/sum
::legacy::set_attribute -quiet original_name cout /designs/full_adder/ports_out/cout
...
## Written on 10:36:49 20-Jun 2025
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_flowkit_db flow_metrics_snapshot_uuid ac26bfe3-e322-4579-9a2a-f6ecf200ef6f}
