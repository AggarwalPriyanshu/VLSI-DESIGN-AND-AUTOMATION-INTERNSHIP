...
set_log_file logs_Jun20-10:36:47/intermediate2final.lec.log -replace

usage -auto -elapse

set_verification_information full_adder_intermediatev_full_adderv_db

read_implementation_information fv/full_adder -golden full_adder_intermediatev -revised full_adderv
...
read_design -verilog95   -golden -lastmod -noelab outputs_Jun20-10:36:47/full_adder_intermediate.v
elaborate_design -golden -root {full_adder}

read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:36:47/full_adder.v
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:36:47/intermediate2final.lec.log
}
