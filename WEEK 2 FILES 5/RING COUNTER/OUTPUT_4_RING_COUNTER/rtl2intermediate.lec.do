...
# Generated on: Thu Jun 19 11:22:42 IST 2025 (Thu Jun 19 05:52:42 UTC 2025)
...
set_log_file logs_Jun19-11:22:41/rtl2intermediate.lec.log -replace

usage -auto -elapse

set_verification_information rtl_ring_counter_intermediatev_db

read_implementation_information fv/ring_counter -revised ring_counter_intermediatev
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/4_RING_COUNTER.v
elaborate_design -golden -root {ring_counter} -rootonly 

read_design -verilog95   -revised -lastmod -noelab outputs_Jun19-11:22:41/ring_counter_intermediate.v
elaborate_design -revised -root {ring_counter}
...
#add_name_alias fv/ring_counter/ring_counter_intermediatev.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun19-11:22:41/rtl2intermediate.lec.log
}
