...
# Generated on: Thu Jun 19 11:22:43 IST 2025 (Thu Jun 19 05:52:43 UTC 2025)
...
set_log_file logs_Jun19-11:22:41/intermediate2final.lec.log -replace

usage -auto -elapse

set_verification_information ring_counter_intermediatev_ring_counterv_db

read_implementation_information fv/ring_counter -golden ring_counter_intermediatev -revised ring_counterv
...
read_design -verilog95   -golden -lastmod -noelab outputs_Jun19-11:22:41/ring_counter_intermediate.v
elaborate_design -golden -root {ring_counter}

read_design -verilog95   -revised -lastmod -noelab outputs_Jun19-11:22:41/ring_counter.v
elaborate_design -revised -root {ring_counter}

#add_name_alias fv/ring_counter/ring_counter_intermediatev.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/ring_counter/ring_counterv.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun19-11:22:41/intermediate2final.lec.log
}
