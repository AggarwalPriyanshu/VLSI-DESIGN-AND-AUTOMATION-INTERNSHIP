...
# This file contains the Genus script for /designs/ring_counter
...
::legacy::set_attribute -quiet runtime_by_stage { {to_generic 1 31 0 4}  {first_condense 0 31 0 4}  {second_condense 0 31 0 4}  {reify 0 31 0 4}  {global_incr_map 0 31 0 4}  {incr_opt 1 32 0 5} } /
...
::legacy::set_attribute -quiet flow_metrics_snapshot_uuid a80a8572-8d5a-4a23-a980-584be1ff8540 /
...
# BEGIN MSV SECTION
# END MSV SECTION
define_cost_group -design /designs/ring_counter -name C2C
define_cost_group -design /designs/ring_counter -name C2O
define_cost_group -design /designs/ring_counter -name I2C
define_cost_group -design /designs/ring_counter -name I2O
path_group -paths [specify_paths -from {{/designs/ring_counter/instances_seq/q_reg[0]} {/designs/ring_counter/instances_seq/q_reg[3]} {/designs/ring_counter/instances_seq/q_reg[2]} {/designs/ring_counter/instances_seq/q_reg[1]}} -to {{/designs/ring_counter/instances_seq/q_reg[0]} {/designs/ring_counter/instances_seq/q_reg[3]} {/designs/ring_counter/instances_seq/q_reg[2]} {/designs/ring_counter/instances_seq/q_reg[1]}}]  -name C2C -group /designs/ring_counter/timing/cost_groups/C2C
path_group -paths [specify_paths -from {{/designs/ring_counter/instances_seq/q_reg[0]} {/designs/ring_counter/instances_seq/q_reg[3]} {/designs/ring_counter/instances_seq/q_reg[2]} {/designs/ring_counter/instances_seq/q_reg[1]}} -to {{/designs/ring_counter/ports_out/q[3]} {/designs/ring_counter/ports_out/q[2]} {/designs/ring_counter/ports_out/q[1]} {/designs/ring_counter/ports_out/q[0]}}]  -name C2O -group /designs/ring_counter/timing/cost_groups/C2O
path_group -paths [specify_paths -from {/designs/ring_counter/ports_in/clk /designs/ring_counter/ports_in/rst} -to {{/designs/ring_counter/instances_seq/q_reg[0]} {/designs/ring_counter/instances_seq/q_reg[3]} {/designs/ring_counter/instances_seq/q_reg[2]} {/designs/ring_counter/instances_seq/q_reg[1]}}]  -name I2C -group /designs/ring_counter/timing/cost_groups/I2C
path_group -paths [specify_paths -from {/designs/ring_counter/ports_in/clk /designs/ring_counter/ports_in/rst} -to {{/designs/ring_counter/ports_out/q[3]} {/designs/ring_counter/ports_out/q[2]} {/designs/ring_counter/ports_out/q[1]} {/designs/ring_counter/ports_out/q[0]}}]  -name I2O -group /designs/ring_counter/timing/cost_groups/I2O
# BEGIN DFT SECTION
::legacy::set_attribute -quiet dft_scan_style muxed_scan /
::legacy::set_attribute -quiet dft_scanbit_waveform_analysis false /
# END DFT SECTION
::legacy::set_attribute -quiet seq_reason_deleted_internal {} /designs/ring_counter
::legacy::set_attribute -quiet qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 4} {utilization  0.00} {runtime 1 31 0 4} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 4} {utilization  0.00} {runtime 0 31 0 4} }{second_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 4} {utilization  0.00} {runtime 0 31 0 4} }{reify {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 5} {utilization  0.00} {runtime 0 31 0 4} }{global_incr_map {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 5} {utilization  0.00} {runtime 0 31 0 4} }{incr_opt {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 5} {utilization  0.00} {runtime 1 32 0 5} }} /designs/ring_counter
::legacy::set_attribute -quiet seq_mbci_coverage 0.0 /designs/ring_counter
::legacy::set_attribute -quiet hdl_filelist {{default -v2001 {SYNTHESIS} {/home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/4_RING_COUNTER.v} {/home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog} {}}} /designs/ring_counter
::legacy::set_attribute -quiet hdl_user_name ring_counter /designs/ring_counter
::legacy::set_attribute -quiet verification_directory fv/ring_counter /designs/ring_counter
::legacy::set_attribute -quiet arch_filename /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/4_RING_COUNTER.v /designs/ring_counter
::legacy::set_attribute -quiet entity_filename /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/4_RING_COUNTER.v /designs/ring_counter
::legacy::set_attribute -quiet original_name clk /designs/ring_counter/ports_in/clk
::legacy::set_attribute -quiet original_name rst /designs/ring_counter/ports_in/rst
::legacy::set_attribute -quiet original_name {q[3]} {/designs/ring_counter/ports_out/q[3]}
::legacy::set_attribute -quiet original_name {q[2]} {/designs/ring_counter/ports_out/q[2]}
::legacy::set_attribute -quiet original_name {q[1]} {/designs/ring_counter/ports_out/q[1]}
::legacy::set_attribute -quiet original_name {q[0]} {/designs/ring_counter/ports_out/q[0]}
::legacy::set_attribute -quiet original_name {{q[0]}} {/designs/ring_counter/instances_seq/q_reg[0]}
::legacy::set_attribute -quiet orig_hdl_instantiated false {/designs/ring_counter/instances_seq/q_reg[0]}
::legacy::set_attribute -quiet single_bit_orig_name {q[0]} {/designs/ring_counter/instances_seq/q_reg[0]}
::legacy::set_attribute -quiet gint_phase_inversion false {/designs/ring_counter/instances_seq/q_reg[0]}
::legacy::set_attribute -quiet original_name {q[0]/q} {/designs/ring_counter/instances_seq/q_reg[0]/pins_out/Q}
::legacy::set_attribute -quiet original_name {{q[3]}} {/designs/ring_counter/instances_seq/q_reg[3]}
::legacy::set_attribute -quiet orig_hdl_instantiated false {/designs/ring_counter/instances_seq/q_reg[3]}
::legacy::set_attribute -quiet single_bit_orig_name {q[3]} {/designs/ring_counter/instances_seq/q_reg[3]}
::legacy::set_attribute -quiet gint_phase_inversion false {/designs/ring_counter/instances_seq/q_reg[3]}
::legacy::set_attribute -quiet original_name {q[3]/q} {/designs/ring_counter/instances_seq/q_reg[3]/pins_out/Q}
::legacy::set_attribute -quiet original_name {{q[2]}} {/designs/ring_counter/instances_seq/q_reg[2]}
::legacy::set_attribute -quiet orig_hdl_instantiated false {/designs/ring_counter/instances_seq/q_reg[2]}
::legacy::set_attribute -quiet single_bit_orig_name {q[2]} {/designs/ring_counter/instances_seq/q_reg[2]}
::legacy::set_attribute -quiet gint_phase_inversion false {/designs/ring_counter/instances_seq/q_reg[2]}
::legacy::set_attribute -quiet original_name {q[2]/q} {/designs/ring_counter/instances_seq/q_reg[2]/pins_out/Q}
::legacy::set_attribute -quiet original_name {{q[1]}} {/designs/ring_counter/instances_seq/q_reg[1]}
::legacy::set_attribute -quiet orig_hdl_instantiated false {/designs/ring_counter/instances_seq/q_reg[1]}
::legacy::set_attribute -quiet single_bit_orig_name {q[1]} {/designs/ring_counter/instances_seq/q_reg[1]}
::legacy::set_attribute -quiet gint_phase_inversion false {/designs/ring_counter/instances_seq/q_reg[1]}
::legacy::set_attribute -quiet original_name {q[1]/q} {/designs/ring_counter/instances_seq/q_reg[1]/pins_out/Q}
...
## Written on 11:22:43 19-Jun 2025
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_flowkit_db flow_metrics_snapshot_uuid a80a8572-8d5a-4a23-a980-584be1ff8540}
