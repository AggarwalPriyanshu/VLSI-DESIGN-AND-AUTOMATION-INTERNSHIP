...
################################################################################
if {[::legacy::find -design /designs/ring_counter] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj /designs/ring_counter
}
...
# Design
################################################################################
read_netlist -top ring_counter outputs_Jun19-11:22:41/ring_counter.v
read_metric -id current outputs_Jun19-11:22:41/ring_counter.metrics.json

phys::read_script outputs_Jun19-11:22:41/ring_counter.g
...
# slack
set _slk_ [::legacy::get_attribute slack /designs/ring_counter]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
...
# multi-mode slack
# tns
set _tns_ [::legacy::get_attribute tns /designs/ring_counter]
if {[regexp {^-?[0-9.]+$} $_tns_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area /designs/ring_counter]
...
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area /designs/ring_counter]
