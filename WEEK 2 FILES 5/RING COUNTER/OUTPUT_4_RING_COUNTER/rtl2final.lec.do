...
set_log_file logs_Jun19-11:22:41/rtl2final.lec.log -replace

usage -auto -elapse

set_verification_information rtl_ring_counter_mv_db

read_implementation_information fv/ring_counter -revised ring_counter_mv
...
read_design -verilog95   -revised -lastmod -noelab outputs_Jun19-11:22:41/ring_counter_m.v
...
#add_name_alias fv/ring_counter/ring_counter_mv.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun19-11:22:41/rtl2final.lec.log
}
