...
set_log_file logs_Jun20-10:50:45/intermediate2final.lec.log -replace

usage -auto -elapse

set_verification_information traffic_light_ctrl_intermediatev_traffic_light_ctrlv_db

read_implementation_information fv/traffic_light_ctrl -golden traffic_light_ctrl_intermediatev -revised traffic_light_ctrlv
...
read_design -verilog95   -golden -lastmod -noelab outputs_Jun20-10:50:45/traffic_light_ctrl_intermediate.v
elaborate_design -golden -root {traffic_light_ctrl}

read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:50:45/traffic_light_ctrl.v
elaborate_design -revised -root {traffic_light_ctrl}

#add_name_alias fv/traffic_light_ctrl/traffic_light_ctrl_intermediatev.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/traffic_light_ctrl/traffic_light_ctrlv.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:50:45/intermediate2final.lec.log
}
