...
# Generated on: Fri Jun 20 10:50:47 IST 2025 (Fri Jun 20 05:20:47 UTC 2025)
...
set_log_file logs_Jun20-10:50:45/rtl2intermediate.lec.log -replace

usage -auto -elapse

set_verification_information rtl_traffic_light_ctrl_intermediatev_db

read_implementation_information fv/traffic_light_ctrl -revised traffic_light_ctrl_intermediatev
...
add_search_path /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/TRAFFIC_LIGHT_CTRL.v
elaborate_design -golden -root {traffic_light_ctrl} -rootonly 

read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:50:45/traffic_light_ctrl_intermediate.v
elaborate_design -revised -root {traffic_light_ctrl}
...
#add_name_alias fv/traffic_light_ctrl/traffic_light_ctrl_intermediatev.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:50:45/rtl2intermediate.lec.log
}
