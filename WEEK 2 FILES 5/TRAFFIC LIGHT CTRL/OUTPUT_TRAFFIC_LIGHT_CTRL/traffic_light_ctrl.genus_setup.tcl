...
################################################################################
if {[::legacy::find -design /designs/traffic_light_ctrl] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj /designs/traffic_light_ctrl
}
...
# Design
################################################################################
read_netlist -top traffic_light_ctrl outputs_Jun20-10:50:45/traffic_light_ctrl.v
read_metric -id current outputs_Jun20-10:50:45/traffic_light_ctrl.metrics.json

phys::read_script outputs_Jun20-10:50:45/traffic_light_ctrl.g
...
# slack
set _slk_ [::legacy::get_attribute slack /designs/traffic_light_ctrl]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
...
# multi-mode slack
# tns
set _tns_ [::legacy::get_attribute tns /designs/traffic_light_ctrl]
if {[regexp {^-?[0-9.]+$} $_tns_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area /designs/traffic_light_ctrl]
...
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area /designs/traffic_light_ctrl]
