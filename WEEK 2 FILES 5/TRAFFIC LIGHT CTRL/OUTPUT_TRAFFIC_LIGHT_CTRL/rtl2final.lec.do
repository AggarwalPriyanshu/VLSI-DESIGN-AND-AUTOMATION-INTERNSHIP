...
set_log_file logs_Jun20-10:50:45/rtl2final.lec.log -replace

usage -auto -elapse

set_verification_information rtl_traffic_light_ctrl_mv_db

read_implementation_information fv/traffic_light_ctrl -revised traffic_light_ctrl_mv
...
read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:50:45/traffic_light_ctrl_m.v
...
#add_name_alias fv/traffic_light_ctrl/traffic_light_ctrl_mv.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:50:45/rtl2final.lec.log
}
