...
# Created by Genus(TM) Synthesis Solution 20.11-s111_1 on Fri Jun 20 10:43:01 IST 2025

# This file contains the Genus script for /designs/mux4to1
...
::legacy::set_attribute -quiet flow_metrics_snapshot_uuid 8b89096d-1ef3-4293-abbb-487ce8205880 /
...
# BEGIN MSV SECTION
# END MSV SECTION
define_cost_group -design /designs/mux4to1 -name I2O
path_group -paths [specify_paths -from {{/designs/mux4to1/ports_in/in[3]} {/designs/mux4to1/ports_in/in[2]} {/designs/mux4to1/ports_in/in[1]} {/designs/mux4to1/ports_in/in[0]} {/designs/mux4to1/ports_in/sel[1]} {/designs/mux4to1/ports_in/sel[0]}} -to /designs/mux4to1/ports_out/y]  -name I2O -group /designs/mux4to1/timing/cost_groups/I2O
# BEGIN DFT SECTION
::legacy::set_attribute -quiet dft_scan_style muxed_scan /
::legacy::set_attribute -quiet dft_scanbit_waveform_analysis false /
# END DFT SECTION
::legacy::set_attribute -quiet seq_reason_deleted_internal {} /designs/mux4to1
::legacy::set_attribute -quiet qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 7} {utilization  0.00} {runtime 0 13 0 4} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 9} {utilization  0.00} {runtime 0 13 0 4} }{second_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 9} {utilization  0.00} {runtime 0 13 0 4} }{reify {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 5} {utilization  0.00} {runtime 0 13 0 4} }{global_incr_map {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 5} {utilization  0.00} {runtime 0 13 0 4} }{incr_opt {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 1} {utilization  0.00} {runtime 0 13 0 4} }} /designs/mux4to1
::legacy::set_attribute -quiet seq_mbci_coverage 0.0 /designs/mux4to1
::legacy::set_attribute -quiet hdl_filelist {{default -v2001 {SYNTHESIS} {/home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/MUX_4_1.v} {/home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog} {}}} /designs/mux4to1
::legacy::set_attribute -quiet hdl_user_name mux4to1 /designs/mux4to1
::legacy::set_attribute -quiet verification_directory fv/mux4to1 /designs/mux4to1
::legacy::set_attribute -quiet arch_filename /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/MUX_4_1.v /designs/mux4to1
::legacy::set_attribute -quiet entity_filename /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/MUX_4_1.v /designs/mux4to1
::legacy::set_attribute -quiet original_name {in[3]} {/designs/mux4to1/ports_in/in[3]}
::legacy::set_attribute -quiet original_name {in[2]} {/designs/mux4to1/ports_in/in[2]}
::legacy::set_attribute -quiet original_name {in[1]} {/designs/mux4to1/ports_in/in[1]}
::legacy::set_attribute -quiet original_name {in[0]} {/designs/mux4to1/ports_in/in[0]}
::legacy::set_attribute -quiet original_name {sel[1]} {/designs/mux4to1/ports_in/sel[1]}
::legacy::set_attribute -quiet original_name {sel[0]} {/designs/mux4to1/ports_in/sel[0]}
::legacy::set_attribute -quiet original_name y /designs/mux4to1/ports_out/y
...
## Written on 10:43:01 20-Jun 2025
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_flowkit_db flow_metrics_snapshot_uuid 8b89096d-1ef3-4293-abbb-487ce8205880}
