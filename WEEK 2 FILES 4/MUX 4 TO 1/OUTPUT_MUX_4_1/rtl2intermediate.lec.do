...
# Generated on: Fri Jun 20 10:43:01 IST 2025 (Fri Jun 20 05:13:01 UTC 2025)
...
set_log_file logs_Jun20-10:43:00/rtl2intermediate.lec.log -replace

usage -auto -elapse

set_verification_information rtl_mux4to1_intermediatev_db

read_implementation_information fv/mux4to1 -revised mux4to1_intermediatev
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/MUX_4_1.v
elaborate_design -golden -root {mux4to1} -rootonly 

read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:43:00/mux4to1_intermediate.v
elaborate_design -revised -root {mux4to1}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:43:00/rtl2intermediate.lec.log
}
