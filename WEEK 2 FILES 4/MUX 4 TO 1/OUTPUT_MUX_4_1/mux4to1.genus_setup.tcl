...
################################################################################
if {[::legacy::find -design /designs/mux4to1] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj /designs/mux4to1
}
...
# Design
################################################################################
read_netlist -top mux4to1 outputs_Jun20-10:43:00/mux4to1.v
read_metric -id current outputs_Jun20-10:43:00/mux4to1.metrics.json

phys::read_script outputs_Jun20-10:43:00/mux4to1.g
...
# slack
set _slk_ [::legacy::get_attribute slack /designs/mux4to1]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
...
# multi-mode slack
# tns
set _tns_ [::legacy::get_attribute tns /designs/mux4to1]
if {[regexp {^-?[0-9.]+$} $_tns_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area /designs/mux4to1]
...
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area /designs/mux4to1]
