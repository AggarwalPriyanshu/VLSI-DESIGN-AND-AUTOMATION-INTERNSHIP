...
set_log_file logs_Jun20-10:43:00/intermediate2final.lec.log -replace

usage -auto -elapse

set_verification_information mux4to1_intermediatev_mux4to1v_db

read_implementation_information fv/mux4to1 -golden mux4to1_intermediatev -revised mux4to1v
...
read_design -verilog95   -golden -lastmod -noelab outputs_Jun20-10:43:00/mux4to1_intermediate.v
elaborate_design -golden -root {mux4to1}

read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:43:00/mux4to1.v
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:43:00/intermediate2final.lec.log
}
