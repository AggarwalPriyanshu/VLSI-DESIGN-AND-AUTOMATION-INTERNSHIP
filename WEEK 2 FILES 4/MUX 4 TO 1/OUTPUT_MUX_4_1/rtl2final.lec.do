...
# Generated on: Fri Jun 20 10:43:02 IST 2025 (Fri Jun 20 05:13:02 UTC 2025)
...
set_log_file logs_Jun20-10:43:00/rtl2final.lec.log -replace

usage -auto -elapse

set_verification_information rtl_mux4to1_mv_db

read_implementation_information fv/mux4to1 -revised mux4to1_mv
...
read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:43:00/mux4to1_m.v
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:43:00/rtl2final.lec.log
}
