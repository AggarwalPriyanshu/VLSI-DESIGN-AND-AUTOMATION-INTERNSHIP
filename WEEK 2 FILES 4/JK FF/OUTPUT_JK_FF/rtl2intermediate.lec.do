...
# Generated on: Fri Jun 20 10:40:27 IST 2025 (Fri Jun 20 05:10:27 UTC 2025)
...
set_log_file logs_Jun20-10:40:26/rtl2intermediate.lec.log -replace

usage -auto -elapse

set_verification_information rtl_jk_ff_intermediatev_db

read_implementation_information fv/jk_ff -revised jk_ff_intermediatev
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/JK_FF.v
elaborate_design -golden -root {jk_ff} -rootonly 

read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:40:26/jk_ff_intermediate.v
elaborate_design -revised -root {jk_ff}
...
#add_name_alias fv/jk_ff/jk_ff_intermediatev.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:40:26/rtl2intermediate.lec.log
}
