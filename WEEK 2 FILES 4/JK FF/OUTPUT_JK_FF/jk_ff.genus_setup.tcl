...
################################################################################
if {[::legacy::find -design /designs/jk_ff] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj /designs/jk_ff
}
...
# Design
################################################################################
read_netlist -top jk_ff outputs_Jun20-10:40:26/jk_ff.v
read_metric -id current outputs_Jun20-10:40:26/jk_ff.metrics.json

phys::read_script outputs_Jun20-10:40:26/jk_ff.g
...
# slack
set _slk_ [::legacy::get_attribute slack /designs/jk_ff]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
...
# multi-mode slack
# tns
set _tns_ [::legacy::get_attribute tns /designs/jk_ff]
if {[regexp {^-?[0-9.]+$} $_tns_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area /designs/jk_ff]
...
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area /designs/jk_ff]
