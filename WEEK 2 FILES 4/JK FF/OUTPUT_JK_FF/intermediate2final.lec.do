...
# Generated on: Fri Jun 20 10:40:28 IST 2025 (Fri Jun 20 05:10:28 UTC 2025)
...
set_log_file logs_Jun20-10:40:26/intermediate2final.lec.log -replace

usage -auto -elapse

set_verification_information jk_ff_intermediatev_jk_ffv_db

read_implementation_information fv/jk_ff -golden jk_ff_intermediatev -revised jk_ffv
...
read_design -verilog95   -golden -lastmod -noelab outputs_Jun20-10:40:26/jk_ff_intermediate.v
elaborate_design -golden -root {jk_ff}

read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:40:26/jk_ff.v
elaborate_design -revised -root {jk_ff}

#add_name_alias fv/jk_ff/jk_ff_intermediatev.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/jk_ff/jk_ffv.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:40:26/intermediate2final.lec.log
}
