...
# Created by Genus(TM) Synthesis Solution 20.11-s111_1 on Fri Jun 20 10:40:27 IST 2025

# This file contains the Genus script for /designs/jk_ff
...
::legacy::set_attribute -quiet runtime_by_stage { {to_generic 0 13 0 4}  {first_condense 0 13 0 4}  {second_condense 0 13 0 4}  {reify 0 13 0 4}  {global_incr_map 0 13 0 4}  {incr_opt 0 13 0 4} } /
...
::legacy::set_attribute -quiet flow_metrics_snapshot_uuid bb555163-8fdf-49d8-97ac-7a2dc4f03301 /
...
# BEGIN MSV SECTION
# END MSV SECTION
define_cost_group -design /designs/jk_ff -name C2C
define_cost_group -design /designs/jk_ff -name C2O
define_cost_group -design /designs/jk_ff -name I2C
define_cost_group -design /designs/jk_ff -name I2O
path_group -paths [specify_paths -from /designs/jk_ff/instances_seq/q_reg -to /designs/jk_ff/instances_seq/q_reg]  -name C2C -group /designs/jk_ff/timing/cost_groups/C2C
path_group -paths [specify_paths -from /designs/jk_ff/instances_seq/q_reg -to /designs/jk_ff/ports_out/q]  -name C2O -group /designs/jk_ff/timing/cost_groups/C2O
path_group -paths [specify_paths -from {/designs/jk_ff/ports_in/j /designs/jk_ff/ports_in/k /designs/jk_ff/ports_in/clk /designs/jk_ff/ports_in/rst} -to /designs/jk_ff/instances_seq/q_reg]  -name I2C -group /designs/jk_ff/timing/cost_groups/I2C
path_group -paths [specify_paths -from {/designs/jk_ff/ports_in/j /designs/jk_ff/ports_in/k /designs/jk_ff/ports_in/clk /designs/jk_ff/ports_in/rst} -to /designs/jk_ff/ports_out/q]  -name I2O -group /designs/jk_ff/timing/cost_groups/I2O
# BEGIN DFT SECTION
::legacy::set_attribute -quiet dft_scan_style muxed_scan /
::legacy::set_attribute -quiet dft_scanbit_waveform_analysis false /
# END DFT SECTION
::legacy::set_attribute -quiet seq_reason_deleted_internal {} /designs/jk_ff
::legacy::set_attribute -quiet qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 3} {utilization  0.00} {runtime 0 13 0 4} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 4} {utilization  0.00} {runtime 0 13 0 4} }{second_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 4} {utilization  0.00} {runtime 0 13 0 4} }{reify {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 4} {utilization  0.00} {runtime 0 13 0 4} }{global_incr_map {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 4} {utilization  0.00} {runtime 0 13 0 4} }{incr_opt {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 3} {utilization  0.00} {runtime 0 13 0 4} }} /designs/jk_ff
::legacy::set_attribute -quiet seq_mbci_coverage 0.0 /designs/jk_ff
::legacy::set_attribute -quiet hdl_filelist {{default -v2001 {SYNTHESIS} {/home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/JK_FF.v} {/home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog} {}}} /designs/jk_ff
::legacy::set_attribute -quiet hdl_user_name jk_ff /designs/jk_ff
::legacy::set_attribute -quiet verification_directory fv/jk_ff /designs/jk_ff
::legacy::set_attribute -quiet arch_filename /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/JK_FF.v /designs/jk_ff
::legacy::set_attribute -quiet entity_filename /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/JK_FF.v /designs/jk_ff
::legacy::set_attribute -quiet original_name j /designs/jk_ff/ports_in/j
::legacy::set_attribute -quiet original_name k /designs/jk_ff/ports_in/k
::legacy::set_attribute -quiet original_name clk /designs/jk_ff/ports_in/clk
::legacy::set_attribute -quiet original_name rst /designs/jk_ff/ports_in/rst
::legacy::set_attribute -quiet original_name q /designs/jk_ff/ports_out/q
::legacy::set_attribute -quiet original_name q /designs/jk_ff/instances_seq/q_reg
::legacy::set_attribute -quiet orig_hdl_instantiated false /designs/jk_ff/instances_seq/q_reg
::legacy::set_attribute -quiet single_bit_orig_name q /designs/jk_ff/instances_seq/q_reg
::legacy::set_attribute -quiet gint_phase_inversion false /designs/jk_ff/instances_seq/q_reg
::legacy::set_attribute -quiet original_name q/q /designs/jk_ff/instances_seq/q_reg/pins_out/Q
::legacy::set_attribute -quiet original_name q/q /designs/jk_ff/instances_seq/q_reg/pins_out/QN
...
## Written on 10:40:28 20-Jun 2025
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_flowkit_db flow_metrics_snapshot_uuid bb555163-8fdf-49d8-97ac-7a2dc4f03301}
