...
set_log_file logs_Jun20-10:40:26/rtl2final.lec.log -replace

usage -auto -elapse

set_verification_information rtl_jk_ff_mv_db

read_implementation_information fv/jk_ff -revised jk_ff_mv
...
read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:40:26/jk_ff_m.v
...
#add_name_alias fv/jk_ff/jk_ff_mv.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:40:26/rtl2final.lec.log
}
