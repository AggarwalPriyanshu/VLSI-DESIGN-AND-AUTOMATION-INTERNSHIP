...
set_log_file logs_Jul25-12:42:17/rtl2final.lec.log -replace

usage -auto -elapse

set_verification_information rtl_digital_safe_mv_db

read_implementation_information fv/digital_safe -revised digital_safe_mv
...
read_design -verilog95   -revised -lastmod -noelab outputs_Jul25-12:42:17/digital_safe_m.v
...
#add_name_alias fv/digital_safe/digital_safe_mv.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jul25-12:42:17/rtl2final.lec.log
}
