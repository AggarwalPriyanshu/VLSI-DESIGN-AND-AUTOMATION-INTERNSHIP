...
################################################################################
if {[::legacy::find -design /designs/digital_safe] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj /designs/digital_safe
}
...
# Libraries
################################################################################
::legacy::set_attribute library {/home/user/Desktop/Priyanshu_Project/library/fast.lib} /


# Design
################################################################################
read_netlist -top digital_safe outputs_Jul25-12:42:17/digital_safe.v
read_metric -id current outputs_Jul25-12:42:17/digital_safe.metrics.json

phys::read_script outputs_Jul25-12:42:17/digital_safe.g
...
# slack
set _slk_ [::legacy::get_attribute slack /designs/digital_safe]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
...
# multi-mode slack
# tns
set _tns_ [::legacy::get_attribute tns /designs/digital_safe]
if {[regexp {^-?[0-9.]+$} $_tns_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area /designs/digital_safe]
...
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area /designs/digital_safe]
