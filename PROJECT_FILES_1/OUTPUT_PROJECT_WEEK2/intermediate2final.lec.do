...
# Generated on: Fri Jul 25 12:42:24 IST 2025 (Fri Jul 25 07:12:24 UTC 2025)
...
set_log_file logs_Jul25-12:42:17/intermediate2final.lec.log -replace

usage -auto -elapse

set_verification_information digital_safe_intermediatev_digital_safev_db

read_implementation_information fv/digital_safe -golden digital_safe_intermediatev -revised digital_safev
...
add_search_path /home/user/Desktop/Priyanshu_Project/library -library -both
read_library -liberty -both /home/user/Desktop/Priyanshu_Project/library/fast.lib

read_design -verilog95   -golden -lastmod -noelab outputs_Jul25-12:42:17/digital_safe_intermediate.v
elaborate_design -golden -root {digital_safe}

read_design -verilog95   -revised -lastmod -noelab outputs_Jul25-12:42:17/digital_safe.v
elaborate_design -revised -root {digital_safe}

#add_name_alias fv/digital_safe/digital_safe_intermediatev.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/digital_safe/digital_safev.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jul25-12:42:17/intermediate2final.lec.log
}
