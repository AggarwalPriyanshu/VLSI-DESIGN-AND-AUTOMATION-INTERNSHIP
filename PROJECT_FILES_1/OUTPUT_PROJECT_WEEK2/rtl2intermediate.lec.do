...
# Generated on: Fri Jul 25 12:42:23 IST 2025 (Fri Jul 25 07:12:23 UTC 2025)
...
set_log_file logs_Jul25-12:42:17/rtl2intermediate.lec.log -replace

usage -auto -elapse

set_verification_information rtl_digital_safe_intermediatev_db

read_implementation_information fv/digital_safe -revised digital_safe_intermediatev
...
add_search_path /home/user/Desktop/Priyanshu_Project/verilog -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  Project.v
elaborate_design -golden -root {digital_safe} -rootonly 

read_design -verilog95   -revised -lastmod -noelab outputs_Jul25-12:42:17/digital_safe_intermediate.v
...
#add_name_alias fv/digital_safe/digital_safe_intermediatev.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jul25-12:42:17/rtl2intermediate.lec.log
}
