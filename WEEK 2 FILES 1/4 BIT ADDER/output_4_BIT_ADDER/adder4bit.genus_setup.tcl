...
################################################################################
if {[::legacy::find -design /designs/adder4bit] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj /designs/adder4bit
}
...
# Design
################################################################################
read_netlist -top adder4bit outputs_Jun19-10:50:14/adder4bit.v
read_metric -id current outputs_Jun19-10:50:14/adder4bit.metrics.json

phys::read_script outputs_Jun19-10:50:14/adder4bit.g
...
# slack
set _slk_ [::legacy::get_attribute slack /designs/adder4bit]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
...
# multi-mode slack
# tns
set _tns_ [::legacy::get_attribute tns /designs/adder4bit]
if {[regexp {^-?[0-9.]+$} $_tns_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area /designs/adder4bit]
...
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area /designs/adder4bit]
