...
set_log_file logs_Jun19-10:50:14/rtl2final.lec.log -replace

usage -auto -elapse

set_verification_information rtl_adder4bit_mv_db

read_implementation_information fv/adder4bit -revised adder4bit_mv
...
read_design -verilog95   -revised -lastmod -noelab outputs_Jun19-10:50:14/adder4bit_m.v
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun19-10:50:14/rtl2final.lec.log
}
