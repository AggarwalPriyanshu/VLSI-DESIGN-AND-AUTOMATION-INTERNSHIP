...
# Generated on: Thu Jun 19 10:50:15 IST 2025 (Thu Jun 19 05:20:15 UTC 2025)
...
set_log_file logs_Jun19-10:50:14/rtl2intermediate.lec.log -replace

usage -auto -elapse

set_verification_information rtl_adder4bit_intermediatev_db

read_implementation_information fv/adder4bit -revised adder4bit_intermediatev
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/4_BIT_ADDER.v
elaborate_design -golden -root {adder4bit} -rootonly 

read_design -verilog95   -revised -lastmod -noelab outputs_Jun19-10:50:14/adder4bit_intermediate.v
elaborate_design -revised -root {adder4bit}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun19-10:50:14/rtl2intermediate.lec.log
}
