...
set_log_file logs_Jun19-10:50:14/intermediate2final.lec.log -replace

usage -auto -elapse

set_verification_information adder4bit_intermediatev_adder4bitv_db

read_implementation_information fv/adder4bit -golden adder4bit_intermediatev -revised adder4bitv
...
read_design -verilog95   -golden -lastmod -noelab outputs_Jun19-10:50:14/adder4bit_intermediate.v
elaborate_design -golden -root {adder4bit}

read_design -verilog95   -revised -lastmod -noelab outputs_Jun19-10:50:14/adder4bit.v
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun19-10:50:14/intermediate2final.lec.log
}
