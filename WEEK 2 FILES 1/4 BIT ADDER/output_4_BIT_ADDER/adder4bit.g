...
# This file contains the Genus script for /designs/adder4bit
...
::legacy::set_attribute -quiet runtime_by_stage { {to_generic 0 25 0 4}  {first_condense 0 25 0 4}  {second_condense 1 26 0 4}  {reify 0 26 0 4}  {global_incr_map 0 26 0 4}  {incr_opt 0 26 0 5} } /
...
::legacy::set_attribute -quiet flow_metrics_snapshot_uuid 148b2cbd-a1b9-4a87-92f7-fa1cce5118f9 /
...
# BEGIN MSV SECTION
# END MSV SECTION
define_cost_group -design /designs/adder4bit -name I2O
path_group -paths [specify_paths -from {{/designs/adder4bit/ports_in/a[3]} {/designs/adder4bit/ports_in/a[2]} {/designs/adder4bit/ports_in/a[1]} {/designs/adder4bit/ports_in/a[0]} {/designs/adder4bit/ports_in/b[3]} {/designs/adder4bit/ports_in/b[2]} {/designs/adder4bit/ports_in/b[1]} {/designs/adder4bit/ports_in/b[0]}} -to {{/designs/adder4bit/ports_out/sum[4]} {/designs/adder4bit/ports_out/sum[3]} {/designs/adder4bit/ports_out/sum[2]} {/designs/adder4bit/ports_out/sum[1]} {/designs/adder4bit/ports_out/sum[0]}}]  -name I2O -group /designs/adder4bit/timing/cost_groups/I2O
# BEGIN DFT SECTION
::legacy::set_attribute -quiet dft_scan_style muxed_scan /
::legacy::set_attribute -quiet dft_scanbit_waveform_analysis false /
# END DFT SECTION
::legacy::set_attribute -quiet seq_reason_deleted_internal {} /designs/adder4bit
::legacy::set_attribute -quiet qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 28} {utilization  0.00} {runtime 0 25 0 4} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 28} {utilization  0.00} {runtime 0 25 0 4} }{second_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 28} {utilization  0.00} {runtime 1 26 0 4} }{reify {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 7} {utilization  0.00} {runtime 0 26 0 4} }{global_incr_map {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 7} {utilization  0.00} {runtime 0 26 0 4} }{incr_opt {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 4} {utilization  0.00} {runtime 0 26 0 5} }} /designs/adder4bit
::legacy::set_attribute -quiet seq_mbci_coverage 0.0 /designs/adder4bit
::legacy::set_attribute -quiet hdl_filelist {{default -v2001 {SYNTHESIS} {/home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/4_BIT_ADDER.v} {/home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog} {}}} /designs/adder4bit
::legacy::set_attribute -quiet hdl_user_name adder4bit /designs/adder4bit
::legacy::set_attribute -quiet verification_directory fv/adder4bit /designs/adder4bit
::legacy::set_attribute -quiet arch_filename /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/4_BIT_ADDER.v /designs/adder4bit
::legacy::set_attribute -quiet entity_filename /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/4_BIT_ADDER.v /designs/adder4bit
::legacy::set_attribute -quiet original_name {a[3]} {/designs/adder4bit/ports_in/a[3]}
::legacy::set_attribute -quiet original_name {a[2]} {/designs/adder4bit/ports_in/a[2]}
::legacy::set_attribute -quiet original_name {a[1]} {/designs/adder4bit/ports_in/a[1]}
::legacy::set_attribute -quiet original_name {a[0]} {/designs/adder4bit/ports_in/a[0]}
::legacy::set_attribute -quiet original_name {b[3]} {/designs/adder4bit/ports_in/b[3]}
::legacy::set_attribute -quiet original_name {b[2]} {/designs/adder4bit/ports_in/b[2]}
::legacy::set_attribute -quiet original_name {b[1]} {/designs/adder4bit/ports_in/b[1]}
::legacy::set_attribute -quiet original_name {b[0]} {/designs/adder4bit/ports_in/b[0]}
::legacy::set_attribute -quiet original_name {sum[4]} {/designs/adder4bit/ports_out/sum[4]}
::legacy::set_attribute -quiet original_name {sum[3]} {/designs/adder4bit/ports_out/sum[3]}
::legacy::set_attribute -quiet original_name {sum[2]} {/designs/adder4bit/ports_out/sum[2]}
::legacy::set_attribute -quiet original_name {sum[1]} {/designs/adder4bit/ports_out/sum[1]}
::legacy::set_attribute -quiet original_name {sum[0]} {/designs/adder4bit/ports_out/sum[0]}
...
## Written on 10:50:15 19-Jun 2025
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_flowkit_db flow_metrics_snapshot_uuid 148b2cbd-a1b9-4a87-92f7-fa1cce5118f9}
