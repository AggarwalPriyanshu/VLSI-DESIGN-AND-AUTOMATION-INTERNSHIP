...
# This file contains the Genus script for /designs/comparator_4bit
...
::legacy::set_attribute -quiet runtime_by_stage { {to_generic 0 15 0 4}  {first_condense 0 15 0 4}  {second_condense 0 15 0 4}  {reify 0 15 0 4}  {global_incr_map 0 15 0 4}  {incr_opt 0 16 0 4} } /
...
::legacy::set_attribute -quiet flow_metrics_snapshot_uuid b62f46c1-09b9-4eb6-81aa-dac75e285f25 /
...
# BEGIN MSV SECTION
# END MSV SECTION
define_cost_group -design /designs/comparator_4bit -name I2O
path_group -paths [specify_paths -from {{/designs/comparator_4bit/ports_in/a[3]} {/designs/comparator_4bit/ports_in/a[2]} {/designs/comparator_4bit/ports_in/a[1]} {/designs/comparator_4bit/ports_in/a[0]} {/designs/comparator_4bit/ports_in/b[3]} {/designs/comparator_4bit/ports_in/b[2]} {/designs/comparator_4bit/ports_in/b[1]} {/designs/comparator_4bit/ports_in/b[0]}} -to {/designs/comparator_4bit/ports_out/gt /designs/comparator_4bit/ports_out/lt /designs/comparator_4bit/ports_out/eq}]  -name I2O -group /designs/comparator_4bit/timing/cost_groups/I2O
# BEGIN DFT SECTION
::legacy::set_attribute -quiet dft_scan_style muxed_scan /
::legacy::set_attribute -quiet dft_scanbit_waveform_analysis false /
# END DFT SECTION
::legacy::set_attribute -quiet seq_reason_deleted_internal {} /designs/comparator_4bit
::legacy::set_attribute -quiet qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 58} {utilization  0.00} {runtime 0 15 0 4} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 35} {utilization  0.00} {runtime 0 15 0 4} }{second_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 35} {utilization  0.00} {runtime 0 15 0 4} }{reify {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 30} {utilization  0.00} {runtime 0 15 0 4} }{global_incr_map {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 30} {utilization  0.00} {runtime 0 15 0 4} }{incr_opt {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 26} {utilization  0.00} {runtime 0 16 0 4} }} /designs/comparator_4bit
::legacy::set_attribute -quiet seq_mbci_coverage 0.0 /designs/comparator_4bit
::legacy::set_attribute -quiet hdl_filelist {{default -v2001 {SYNTHESIS} {/home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/COMPARATOR_4_BIT.v} {/home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog} {}}} /designs/comparator_4bit
::legacy::set_attribute -quiet hdl_user_name comparator_4bit /designs/comparator_4bit
::legacy::set_attribute -quiet verification_directory fv/comparator_4bit /designs/comparator_4bit
::legacy::set_attribute -quiet arch_filename /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/COMPARATOR_4_BIT.v /designs/comparator_4bit
::legacy::set_attribute -quiet entity_filename /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/COMPARATOR_4_BIT.v /designs/comparator_4bit
::legacy::set_attribute -quiet original_name {a[3]} {/designs/comparator_4bit/ports_in/a[3]}
::legacy::set_attribute -quiet original_name {a[2]} {/designs/comparator_4bit/ports_in/a[2]}
::legacy::set_attribute -quiet original_name {a[1]} {/designs/comparator_4bit/ports_in/a[1]}
::legacy::set_attribute -quiet original_name {a[0]} {/designs/comparator_4bit/ports_in/a[0]}
::legacy::set_attribute -quiet original_name {b[3]} {/designs/comparator_4bit/ports_in/b[3]}
::legacy::set_attribute -quiet original_name {b[2]} {/designs/comparator_4bit/ports_in/b[2]}
::legacy::set_attribute -quiet original_name {b[1]} {/designs/comparator_4bit/ports_in/b[1]}
::legacy::set_attribute -quiet original_name {b[0]} {/designs/comparator_4bit/ports_in/b[0]}
::legacy::set_attribute -quiet original_name gt /designs/comparator_4bit/ports_out/gt
::legacy::set_attribute -quiet original_name lt /designs/comparator_4bit/ports_out/lt
::legacy::set_attribute -quiet original_name eq /designs/comparator_4bit/ports_out/eq
...
## Written on 10:18:38 20-Jun 2025
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_flowkit_db flow_metrics_snapshot_uuid b62f46c1-09b9-4eb6-81aa-dac75e285f25}
