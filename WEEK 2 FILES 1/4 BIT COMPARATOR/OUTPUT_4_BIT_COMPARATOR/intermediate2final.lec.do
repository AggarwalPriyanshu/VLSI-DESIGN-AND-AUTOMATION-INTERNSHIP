...
set_log_file logs_Jun20-10:18:36/intermediate2final.lec.log -replace

usage -auto -elapse

set_verification_information comparator_4bit_intermediatev_comparator_4bitv_db

read_implementation_information fv/comparator_4bit -golden comparator_4bit_intermediatev -revised comparator_4bitv
...
read_design -verilog95   -golden -lastmod -noelab outputs_Jun20-10:18:36/comparator_4bit_intermediate.v
elaborate_design -golden -root {comparator_4bit}

read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:18:36/comparator_4bit.v
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:18:36/intermediate2final.lec.log
}
