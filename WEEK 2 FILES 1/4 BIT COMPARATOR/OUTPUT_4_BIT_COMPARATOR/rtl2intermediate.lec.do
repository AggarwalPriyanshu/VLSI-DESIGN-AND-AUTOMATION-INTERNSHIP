...
# Generated on: Fri Jun 20 10:18:38 IST 2025 (Fri Jun 20 04:48:38 UTC 2025)
...
set_log_file logs_Jun20-10:18:36/rtl2intermediate.lec.log -replace

usage -auto -elapse

set_verification_information rtl_comparator_4bit_intermediatev_db

read_implementation_information fv/comparator_4bit -revised comparator_4bit_intermediatev
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/COMPARATOR_4_BIT.v
elaborate_design -golden -root {comparator_4bit} -rootonly 

read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:18:36/comparator_4bit_intermediate.v
elaborate_design -revised -root {comparator_4bit}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:18:36/rtl2intermediate.lec.log
}
