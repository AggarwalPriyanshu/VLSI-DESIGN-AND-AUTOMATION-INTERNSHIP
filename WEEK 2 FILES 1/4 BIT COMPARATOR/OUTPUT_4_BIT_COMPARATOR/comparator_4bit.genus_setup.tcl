...
################################################################################
if {[::legacy::find -design /designs/comparator_4bit] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj /designs/comparator_4bit
}
...
# Design
################################################################################
read_netlist -top comparator_4bit outputs_Jun20-10:18:36/comparator_4bit.v
read_metric -id current outputs_Jun20-10:18:36/comparator_4bit.metrics.json

phys::read_script outputs_Jun20-10:18:36/comparator_4bit.g
...
# slack
set _slk_ [::legacy::get_attribute slack /designs/comparator_4bit]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
...
# multi-mode slack
# tns
set _tns_ [::legacy::get_attribute tns /designs/comparator_4bit]
if {[regexp {^-?[0-9.]+$} $_tns_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area /designs/comparator_4bit]
...
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area /designs/comparator_4bit]
