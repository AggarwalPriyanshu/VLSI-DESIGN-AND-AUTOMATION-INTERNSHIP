...
// Generated on: Jun 19 2025 11:16:16 IST (Jun 19 2025 05:46:16 UTC)
...
module comparator4bit(a, b, gt, eq, lt);
  ...
  OAI31XL g470(.A0 (n_1), .A1 (a[0]), .A2 (n_11), .B0 (n_13), .Y
       (n_24));
  OAI31XL g471(.A0 (n_0), .A1 (b[0]), .A2 (n_41), .B0 (n_10), .Y
       (n_23));
  ...
  AOI2BB1X4 g2(.A0N (n_20), .A1N (n_25), .B0 (n_19), .Y (gt));
  AOI2BB1X4 g496(.A0N (n_15), .A1N (n_24), .B0 (n_18), .Y (n_39));
  AOI2BB1X4 g497(.A0N (n_19), .A1N (n_39), .B0 (n_20), .Y (lt));
  CLKAND2X12 g498(.A (n_8), .B (b[1]), .Y (n_41));
endmodule
