...
set_log_file logs_Jun20-10:46:54/intermediate2final.lec.log -replace

usage -auto -elapse

set_verification_information up_counter_4bit_intermediatev_up_counter_4bitv_db

read_implementation_information fv/up_counter_4bit -golden up_counter_4bit_intermediatev -revised up_counter_4bitv
...
read_design -verilog95   -golden -lastmod -noelab outputs_Jun20-10:46:54/up_counter_4bit_intermediate.v
elaborate_design -golden -root {up_counter_4bit}

read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:46:54/up_counter_4bit.v
elaborate_design -revised -root {up_counter_4bit}

#add_name_alias fv/up_counter_4bit/up_counter_4bit_intermediatev.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/up_counter_4bit/up_counter_4bitv.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:46:54/intermediate2final.lec.log
}
