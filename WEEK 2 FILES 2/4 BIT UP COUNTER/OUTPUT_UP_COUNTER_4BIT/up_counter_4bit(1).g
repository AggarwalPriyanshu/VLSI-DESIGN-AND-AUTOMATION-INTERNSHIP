...
# This file contains the Genus script for /designs/up_counter_4bit
...
::legacy::set_attribute -quiet runtime_by_stage { {to_generic 0 15 0 4}  {first_condense 0 15 0 4}  {second_condense 0 15 0 4}  {reify 1 16 0 4}  {global_incr_map 0 16 0 4}  {incr_opt 0 16 0 4} } /
...
::legacy::set_attribute -quiet flow_metrics_snapshot_uuid 36aa9f4b-166e-4d45-8cfe-921cfeaa9920 /
...
# BEGIN MSV SECTION
# END MSV SECTION
define_cost_group -design /designs/up_counter_4bit -name C2C
define_cost_group -design /designs/up_counter_4bit -name C2O
define_cost_group -design /designs/up_counter_4bit -name I2C
define_cost_group -design /designs/up_counter_4bit -name I2O
path_group -paths [specify_paths -from {{/designs/up_counter_4bit/instances_seq/count_reg[3]} {/designs/up_counter_4bit/instances_seq/count_reg[2]} {/designs/up_counter_4bit/instances_seq/count_reg[1]} {/designs/up_counter_4bit/instances_seq/count_reg[0]}} -to {{/designs/up_counter_4bit/instances_seq/count_reg[3]} {/designs/up_counter_4bit/instances_seq/count_reg[2]} {/designs/up_counter_4bit/instances_seq/count_reg[1]} {/designs/up_counter_4bit/instances_seq/count_reg[0]}}]  -name C2C -group /designs/up_counter_4bit/timing/cost_groups/C2C
path_group -paths [specify_paths -from {{/designs/up_counter_4bit/instances_seq/count_reg[3]} {/designs/up_counter_4bit/instances_seq/count_reg[2]} {/designs/up_counter_4bit/instances_seq/count_reg[1]} {/designs/up_counter_4bit/instances_seq/count_reg[0]}} -to {{/designs/up_counter_4bit/ports_out/count[3]} {/designs/up_counter_4bit/ports_out/count[2]} {/designs/up_counter_4bit/ports_out/count[1]} {/designs/up_counter_4bit/ports_out/count[0]}}]  -name C2O -group /designs/up_counter_4bit/timing/cost_groups/C2O
path_group -paths [specify_paths -from {/designs/up_counter_4bit/ports_in/clk /designs/up_counter_4bit/ports_in/rst} -to {{/designs/up_counter_4bit/instances_seq/count_reg[3]} {/designs/up_counter_4bit/instances_seq/count_reg[2]} {/designs/up_counter_4bit/instances_seq/count_reg[1]} {/designs/up_counter_4bit/instances_seq/count_reg[0]}}]  -name I2C -group /designs/up_counter_4bit/timing/cost_groups/I2C
path_group -paths [specify_paths -from {/designs/up_counter_4bit/ports_in/clk /designs/up_counter_4bit/ports_in/rst} -to {{/designs/up_counter_4bit/ports_out/count[3]} {/designs/up_counter_4bit/ports_out/count[2]} {/designs/up_counter_4bit/ports_out/count[1]} {/designs/up_counter_4bit/ports_out/count[0]}}]  -name I2O -group /designs/up_counter_4bit/timing/cost_groups/I2O
# BEGIN DFT SECTION
::legacy::set_attribute -quiet dft_scan_style muxed_scan /
::legacy::set_attribute -quiet dft_scanbit_waveform_analysis false /
# END DFT SECTION
::legacy::set_attribute -quiet seq_reason_deleted_internal {} /designs/up_counter_4bit
::legacy::set_attribute -quiet qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 11} {utilization  0.00} {runtime 0 15 0 4} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 16} {utilization  0.00} {runtime 0 15 0 4} }{second_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 16} {utilization  0.00} {runtime 0 15 0 4} }{reify {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 14} {utilization  0.00} {runtime 1 16 0 4} }{global_incr_map {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 14} {utilization  0.00} {runtime 0 16 0 4} }{incr_opt {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 9} {utilization  0.00} {runtime 0 16 0 4} }} /designs/up_counter_4bit
::legacy::set_attribute -quiet seq_mbci_coverage 0.0 /designs/up_counter_4bit
::legacy::set_attribute -quiet hdl_filelist {{default -v2001 {SYNTHESIS} {/home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/UP_COUNTER_4BIT.v} {/home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog} {}}} /designs/up_counter_4bit
::legacy::set_attribute -quiet hdl_user_name up_counter_4bit /designs/up_counter_4bit
::legacy::set_attribute -quiet verification_directory fv/up_counter_4bit /designs/up_counter_4bit
::legacy::set_attribute -quiet arch_filename /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/UP_COUNTER_4BIT.v /designs/up_counter_4bit
::legacy::set_attribute -quiet entity_filename /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/UP_COUNTER_4BIT.v /designs/up_counter_4bit
::legacy::set_attribute -quiet original_name clk /designs/up_counter_4bit/ports_in/clk
::legacy::set_attribute -quiet original_name rst /designs/up_counter_4bit/ports_in/rst
::legacy::set_attribute -quiet original_name {count[3]} {/designs/up_counter_4bit/ports_out/count[3]}
::legacy::set_attribute -quiet original_name {count[2]} {/designs/up_counter_4bit/ports_out/count[2]}
::legacy::set_attribute -quiet original_name {count[1]} {/designs/up_counter_4bit/ports_out/count[1]}
::legacy::set_attribute -quiet original_name {count[0]} {/designs/up_counter_4bit/ports_out/count[0]}
::legacy::set_attribute -quiet original_name {{count[3]}} {/designs/up_counter_4bit/instances_seq/count_reg[3]}
::legacy::set_attribute -quiet orig_hdl_instantiated false {/designs/up_counter_4bit/instances_seq/count_reg[3]}
::legacy::set_attribute -quiet single_bit_orig_name {count[3]} {/designs/up_counter_4bit/instances_seq/count_reg[3]}
::legacy::set_attribute -quiet gint_phase_inversion false {/designs/up_counter_4bit/instances_seq/count_reg[3]}
::legacy::set_attribute -quiet original_name {count[3]/q} {/designs/up_counter_4bit/instances_seq/count_reg[3]/pins_out/Q}
::legacy::set_attribute -quiet original_name {count[3]/q} {/designs/up_counter_4bit/instances_seq/count_reg[3]/pins_out/QN}
::legacy::set_attribute -quiet original_name {{count[2]}} {/designs/up_counter_4bit/instances_seq/count_reg[2]}
::legacy::set_attribute -quiet orig_hdl_instantiated false {/designs/up_counter_4bit/instances_seq/count_reg[2]}
::legacy::set_attribute -quiet single_bit_orig_name {count[2]} {/designs/up_counter_4bit/instances_seq/count_reg[2]}
::legacy::set_attribute -quiet gint_phase_inversion false {/designs/up_counter_4bit/instances_seq/count_reg[2]}
::legacy::set_attribute -quiet original_name {count[2]/q} {/designs/up_counter_4bit/instances_seq/count_reg[2]/pins_out/Q}
::legacy::set_attribute -quiet original_name {count[2]/q} {/designs/up_counter_4bit/instances_seq/count_reg[2]/pins_out/QN}
::legacy::set_attribute -quiet original_name {{count[1]}} {/designs/up_counter_4bit/instances_seq/count_reg[1]}
::legacy::set_attribute -quiet orig_hdl_instantiated false {/designs/up_counter_4bit/instances_seq/count_reg[1]}
::legacy::set_attribute -quiet single_bit_orig_name {count[1]} {/designs/up_counter_4bit/instances_seq/count_reg[1]}
::legacy::set_attribute -quiet gint_phase_inversion false {/designs/up_counter_4bit/instances_seq/count_reg[1]}
::legacy::set_attribute -quiet original_name {count[1]/q} {/designs/up_counter_4bit/instances_seq/count_reg[1]/pins_out/Q}
::legacy::set_attribute -quiet original_name {count[1]/q} {/designs/up_counter_4bit/instances_seq/count_reg[1]/pins_out/QN}
::legacy::set_attribute -quiet original_name {{count[0]}} {/designs/up_counter_4bit/instances_seq/count_reg[0]}
::legacy::set_attribute -quiet orig_hdl_instantiated false {/designs/up_counter_4bit/instances_seq/count_reg[0]}
::legacy::set_attribute -quiet single_bit_orig_name {count[0]} {/designs/up_counter_4bit/instances_seq/count_reg[0]}
::legacy::set_attribute -quiet gint_phase_inversion false {/designs/up_counter_4bit/instances_seq/count_reg[0]}
::legacy::set_attribute -quiet original_name {count[0]/q} {/designs/up_counter_4bit/instances_seq/count_reg[0]/pins_out/Q}
::legacy::set_attribute -quiet original_name {count[0]/q} {/designs/up_counter_4bit/instances_seq/count_reg[0]/pins_out/QN}
...
## Written on 10:46:55 20-Jun 2025
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_flowkit_db flow_metrics_snapshot_uuid 36aa9f4b-166e-4d45-8cfe-921cfeaa9920}
