...
# Generated on: Fri Jun 20 10:46:56 IST 2025 (Fri Jun 20 05:16:56 UTC 2025)
...
set_log_file logs_Jun20-10:46:54/rtl2final.lec.log -replace

usage -auto -elapse

set_verification_information rtl_up_counter_4bit_mv_db

read_implementation_information fv/up_counter_4bit -revised up_counter_4bit_mv
...
read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:46:54/up_counter_4bit_m.v
...
#add_name_alias fv/up_counter_4bit/up_counter_4bit_mv.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:46:54/rtl2final.lec.log
}
