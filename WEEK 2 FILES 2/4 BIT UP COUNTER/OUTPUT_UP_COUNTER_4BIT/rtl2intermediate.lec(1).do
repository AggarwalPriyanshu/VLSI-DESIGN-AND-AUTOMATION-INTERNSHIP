...
# Generated on: Fri Jun 20 10:46:55 IST 2025 (Fri Jun 20 05:16:55 UTC 2025)
...
set_log_file logs_Jun20-10:46:54/rtl2intermediate.lec.log -replace

usage -auto -elapse

set_verification_information rtl_up_counter_4bit_intermediatev_db

read_implementation_information fv/up_counter_4bit -revised up_counter_4bit_intermediatev
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/UP_COUNTER_4BIT.v
elaborate_design -golden -root {up_counter_4bit} -rootonly 

read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:46:54/up_counter_4bit_intermediate.v
elaborate_design -revised -root {up_counter_4bit}
...
#add_name_alias fv/up_counter_4bit/up_counter_4bit_intermediatev.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:46:54/rtl2intermediate.lec.log
}
