...
# Created by Genus(TM) Synthesis Solution 20.11-s111_1 on Fri Jun 20 10:31:32 IST 2025

# This file contains the Genus script for /designs/down_counter_4bit
...
::legacy::set_attribute -quiet runtime_by_stage { {to_generic 0 23 0 4}  {first_condense 0 23 0 4}  {second_condense 0 23 0 4}  {reify 0 23 0 4}  {global_incr_map 0 23 0 4}  {incr_opt 0 24 0 5} } /
...
::legacy::set_attribute -quiet flow_metrics_snapshot_uuid 1137f99c-14be-4785-b04c-92c8e0f72ed3 /
...
# BEGIN MSV SECTION
# END MSV SECTION
define_cost_group -design /designs/down_counter_4bit -name C2C
define_cost_group -design /designs/down_counter_4bit -name C2O
define_cost_group -design /designs/down_counter_4bit -name I2C
define_cost_group -design /designs/down_counter_4bit -name I2O
path_group -paths [specify_paths -from {{/designs/down_counter_4bit/instances_seq/count_reg[2]} {/designs/down_counter_4bit/instances_seq/count_reg[1]} {/designs/down_counter_4bit/instances_seq/count_reg[0]} {/designs/down_counter_4bit/instances_seq/count_reg[3]}} -to {{/designs/down_counter_4bit/instances_seq/count_reg[2]} {/designs/down_counter_4bit/instances_seq/count_reg[1]} {/designs/down_counter_4bit/instances_seq/count_reg[0]} {/designs/down_counter_4bit/instances_seq/count_reg[3]}}]  -name C2C -group /designs/down_counter_4bit/timing/cost_groups/C2C
path_group -paths [specify_paths -from {{/designs/down_counter_4bit/instances_seq/count_reg[2]} {/designs/down_counter_4bit/instances_seq/count_reg[1]} {/designs/down_counter_4bit/instances_seq/count_reg[0]} {/designs/down_counter_4bit/instances_seq/count_reg[3]}} -to {{/designs/down_counter_4bit/ports_out/count[3]} {/designs/down_counter_4bit/ports_out/count[2]} {/designs/down_counter_4bit/ports_out/count[1]} {/designs/down_counter_4bit/ports_out/count[0]}}]  -name C2O -group /designs/down_counter_4bit/timing/cost_groups/C2O
path_group -paths [specify_paths -from {/designs/down_counter_4bit/ports_in/clk /designs/down_counter_4bit/ports_in/rst} -to {{/designs/down_counter_4bit/instances_seq/count_reg[2]} {/designs/down_counter_4bit/instances_seq/count_reg[1]} {/designs/down_counter_4bit/instances_seq/count_reg[0]} {/designs/down_counter_4bit/instances_seq/count_reg[3]}}]  -name I2C -group /designs/down_counter_4bit/timing/cost_groups/I2C
path_group -paths [specify_paths -from {/designs/down_counter_4bit/ports_in/clk /designs/down_counter_4bit/ports_in/rst} -to {{/designs/down_counter_4bit/ports_out/count[3]} {/designs/down_counter_4bit/ports_out/count[2]} {/designs/down_counter_4bit/ports_out/count[1]} {/designs/down_counter_4bit/ports_out/count[0]}}]  -name I2O -group /designs/down_counter_4bit/timing/cost_groups/I2O
# BEGIN DFT SECTION
::legacy::set_attribute -quiet dft_scan_style muxed_scan /
::legacy::set_attribute -quiet dft_scanbit_waveform_analysis false /
# END DFT SECTION
::legacy::set_attribute -quiet seq_reason_deleted_internal {} /designs/down_counter_4bit
::legacy::set_attribute -quiet qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 11} {utilization  0.00} {runtime 0 23 0 4} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 14} {utilization  0.00} {runtime 0 23 0 4} }{second_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 0} {cell_count 14} {utilization  0.00} {runtime 0 23 0 4} }{reify {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 17} {utilization  0.00} {runtime 0 23 0 4} }{global_incr_map {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 17} {utilization  0.00} {runtime 0 23 0 4} }{incr_opt {wns 214748365} {tns 0} {vep 0} {area 0} {cell_count 14} {utilization  0.00} {runtime 0 24 0 5} }} /designs/down_counter_4bit
::legacy::set_attribute -quiet seq_mbci_coverage 0.0 /designs/down_counter_4bit
::legacy::set_attribute -quiet hdl_filelist {{default -v2001 {SYNTHESIS} {/home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/DOWN_COUNTER_4BIT.v} {/home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog} {}}} /designs/down_counter_4bit
::legacy::set_attribute -quiet hdl_user_name down_counter_4bit /designs/down_counter_4bit
::legacy::set_attribute -quiet verification_directory fv/down_counter_4bit /designs/down_counter_4bit
::legacy::set_attribute -quiet arch_filename /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/DOWN_COUNTER_4BIT.v /designs/down_counter_4bit
::legacy::set_attribute -quiet entity_filename /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/DOWN_COUNTER_4BIT.v /designs/down_counter_4bit
::legacy::set_attribute -quiet original_name clk /designs/down_counter_4bit/ports_in/clk
::legacy::set_attribute -quiet original_name rst /designs/down_counter_4bit/ports_in/rst
::legacy::set_attribute -quiet original_name {count[3]} {/designs/down_counter_4bit/ports_out/count[3]}
::legacy::set_attribute -quiet original_name {count[2]} {/designs/down_counter_4bit/ports_out/count[2]}
::legacy::set_attribute -quiet original_name {count[1]} {/designs/down_counter_4bit/ports_out/count[1]}
::legacy::set_attribute -quiet original_name {count[0]} {/designs/down_counter_4bit/ports_out/count[0]}
::legacy::set_attribute -quiet original_name {{count[2]}} {/designs/down_counter_4bit/instances_seq/count_reg[2]}
::legacy::set_attribute -quiet orig_hdl_instantiated false {/designs/down_counter_4bit/instances_seq/count_reg[2]}
::legacy::set_attribute -quiet single_bit_orig_name {count[2]} {/designs/down_counter_4bit/instances_seq/count_reg[2]}
::legacy::set_attribute -quiet gint_phase_inversion false {/designs/down_counter_4bit/instances_seq/count_reg[2]}
::legacy::set_attribute -quiet original_name {count[2]/q} {/designs/down_counter_4bit/instances_seq/count_reg[2]/pins_out/Q}
::legacy::set_attribute -quiet original_name {{count[1]}} {/designs/down_counter_4bit/instances_seq/count_reg[1]}
::legacy::set_attribute -quiet orig_hdl_instantiated false {/designs/down_counter_4bit/instances_seq/count_reg[1]}
::legacy::set_attribute -quiet single_bit_orig_name {count[1]} {/designs/down_counter_4bit/instances_seq/count_reg[1]}
::legacy::set_attribute -quiet gint_phase_inversion false {/designs/down_counter_4bit/instances_seq/count_reg[1]}
::legacy::set_attribute -quiet original_name {count[1]/q} {/designs/down_counter_4bit/instances_seq/count_reg[1]/pins_out/Q}
::legacy::set_attribute -quiet original_name {{count[0]}} {/designs/down_counter_4bit/instances_seq/count_reg[0]}
::legacy::set_attribute -quiet orig_hdl_instantiated false {/designs/down_counter_4bit/instances_seq/count_reg[0]}
::legacy::set_attribute -quiet single_bit_orig_name {count[0]} {/designs/down_counter_4bit/instances_seq/count_reg[0]}
::legacy::set_attribute -quiet gint_phase_inversion false {/designs/down_counter_4bit/instances_seq/count_reg[0]}
::legacy::set_attribute -quiet original_name {count[0]/q} {/designs/down_counter_4bit/instances_seq/count_reg[0]/pins_out/Q}
::legacy::set_attribute -quiet original_name {count[0]/q} {/designs/down_counter_4bit/instances_seq/count_reg[0]/pins_out/QN}
::legacy::set_attribute -quiet original_name {{count[3]}} {/designs/down_counter_4bit/instances_seq/count_reg[3]}
::legacy::set_attribute -quiet orig_hdl_instantiated false {/designs/down_counter_4bit/instances_seq/count_reg[3]}
::legacy::set_attribute -quiet single_bit_orig_name {count[3]} {/designs/down_counter_4bit/instances_seq/count_reg[3]}
::legacy::set_attribute -quiet gint_phase_inversion false {/designs/down_counter_4bit/instances_seq/count_reg[3]}
::legacy::set_attribute -quiet original_name {count[3]/q} {/designs/down_counter_4bit/instances_seq/count_reg[3]/pins_out/Q}
::legacy::set_attribute -quiet original_name {count[3]/q} {/designs/down_counter_4bit/instances_seq/count_reg[3]/pins_out/QN}
...
## Written on 10:31:32 20-Jun 2025
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_flowkit_db flow_metrics_snapshot_uuid 1137f99c-14be-4785-b04c-92c8e0f72ed3}
