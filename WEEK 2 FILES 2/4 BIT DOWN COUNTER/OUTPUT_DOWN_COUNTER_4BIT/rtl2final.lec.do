...
set_log_file logs_Jun20-10:31:30/rtl2final.lec.log -replace

usage -auto -elapse

set_verification_information rtl_down_counter_4bit_mv_db

read_implementation_information fv/down_counter_4bit -revised down_counter_4bit_mv
...
read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:31:30/down_counter_4bit_m.v
...
#add_name_alias fv/down_counter_4bit/down_counter_4bit_mv.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:31:30/rtl2final.lec.log
}
