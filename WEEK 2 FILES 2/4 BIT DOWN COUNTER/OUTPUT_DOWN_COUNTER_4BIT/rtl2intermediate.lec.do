...
# Generated on: Fri Jun 20 10:31:32 IST 2025 (Fri Jun 20 05:01:32 UTC 2025)
...
set_log_file logs_Jun20-10:31:30/rtl2intermediate.lec.log -replace

usage -auto -elapse

set_verification_information rtl_down_counter_4bit_intermediatev_db

read_implementation_information fv/down_counter_4bit -revised down_counter_4bit_intermediatev
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/user/Desktop/PRIYANSHU_VLSI_SUMMER/genus/verilog/DOWN_COUNTER_4BIT.v
elaborate_design -golden -root {down_counter_4bit} -rootonly 

read_design -verilog95   -revised -lastmod -noelab outputs_Jun20-10:31:30/down_counter_4bit_intermediate.v
elaborate_design -revised -root {down_counter_4bit}
...
#add_name_alias fv/down_counter_4bit/down_counter_4bit_intermediatev.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Jun20-10:31:30/rtl2intermediate.lec.log
}
